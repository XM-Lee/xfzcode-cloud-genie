...
public class VelocityUtils {
    ...
    public static void setTreeVelocityContext(VelocityContext context, GenTableDTO genTable) {
        ...
        context.put(GenConstants.TREE_CODE, treeCode);
        context.put(GenConstants.TREE_PARENT_CODE, treeParentCode);
        context.put(GenConstants.TREE_NAME, treeName);
    ...
    public static List<String> getTemplateList(String tplCategory) {
        ...
        templates.add("templates/generator/java/entity.java.vm");
        templates.add("templates/generator/java/controller.java.vm");
        templates.add("templates/generator/java/service.java.vm");
        templates.add("templates/generator/java/serviceImpl.java.vm");
        templates.add("templates/generator/java/mapper.java.vm");
        templates.add("templates/generator/xml/mapper.xml.vm");
        templates.add("templates/generator/sql/sql.vm");
        //todo 增加前端页面相关的模板
